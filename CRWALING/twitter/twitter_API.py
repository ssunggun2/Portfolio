...
class TwitterCrawling():
  ...
  def start(self,keyword,max_tweets,addr):
    ...
    data_info_frame.to_csv(self.addr+keyword+'.csv', encoding='utf-8-sig')
...
addr = 'C:/Users/User/Desktop/workspace/vsc/CRWALING/twitter/twt_1500/'

for keyword in name_artist[:]: # 아티스트 3명만 추출 후 엑셀 저장
