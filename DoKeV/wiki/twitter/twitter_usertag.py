...
def getTweetusertag(usertag):
    ...
    headers = {
                ...
                ,'cookie' : '_ga=GA1.2.54194508.1580911417; personalization_id="v1_GlNYc83i70TLfQS4OK9J/Q=="; guest_id=v1%3A159770765832025085; G_ENABLED_IDPS=google; kdt=rGowPp2pFbiN33DoGCUhRHDdP2f3A06Q3zQv8UV3; auth_token=e9d3de78b7d129aa64c3da6efbf087e5f2eee869; ct0=1e340d3de2bbf4a25b69b0bd70c1e8cd266e12106bea9bf2edf4568f084c23859a8450986cbb1916d869d1f1c3c3474b8fa6953b258f133c1c9484bb790c6d471c143389d9d1eaac80c77d456ed3e63c; twid=u%3D1426035705860427788; des_opt_in=N; mbox=PC#f1d7518763064a7e9a57555614e6874e.32_0#1693810079|session#6d62405d60b94c0b9a03b3d214f2ccc5#1630567108; _gid=GA1.2.754230164.1630917305; lang=ko; external_referer=padhuUp37zjgzgv1mFWxJ12Ozwit7owX|0|8e8t2xd8A2w%3D'
    ...
    for i in range(100):
        try:
            ...
            respone2 = requests.get('https://twitter.com/i/api/graphql/UlRJ6hFoPvmZAwlQ_IrbhQ/UserTweets', headers=headers, params=params)
